  ...
  chart: function() {
    ...
    function setTooltip(tooltip, msg){
      if(msg == false || msg == undefined){
        ...
        //Manually Added
        //d3.select(tooltip.node().parentNode).moveToFront();
      ...
      selection.each(function(data) {
        ...
        polygon.enter().append('polygon')
          ...
          // setTooltip(tooltip, cfg.tooltipFormatClass(dd.className));
            // setTooltip(tooltip, cfg.tooltipFormatClass(dd[0].className));
           // tooltip.moveToFront();
          })
        ...
        if(cfg.circles && cfg.radius) {
          ...
          var circleGroups = container.selectAll('g.circle-group').data(data);
